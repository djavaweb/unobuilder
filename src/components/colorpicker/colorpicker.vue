<template>
  <a class="c-picker" :style="{background: activeColor}" @click="toggle()"></a>

  <div class="c-picker-overlay" v-show="show"></div>
  <div class="c-picker-wrapper" v-show="show">
    <div class="c-sketch">
      ...
      <a @click="show=false" class="c-picker-ok">OK</a>
    </div>
  </div>
</template>
